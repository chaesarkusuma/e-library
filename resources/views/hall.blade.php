            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    <h5 class="text-lg font-bold">
                        <a href="/hall/{{ $book->slug }}" class="hover:text-blue-500 capitalize">{{ $book->name }}</a>
                    </h5>
                    ...
                    <a href="/hall/{{ $book->slug }}" class="mt-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
                        Read more
                    </a>
                </div>
            </div>
