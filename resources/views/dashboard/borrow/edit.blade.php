                ...
                <form action="/dashboard/borrow/{{ $borrow->id }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $borrow->user->name }}" disabled
                            class="mt-1 p-2 block w-full rounded-md border-gray-300 border shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('user_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $borrow->book->name }}" disabled
                            class="mt-1 p-2 block w-full rounded-md border-gray-300 border shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('book_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $borrow->borrowed_date->format('d M Y') }}" disabled
                            class="mt-1 p-2 block w-full rounded-md border-gray-300 border shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('borrow_date') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $borrow->due_date->format('d M Y') }}" disabled
                            class="mt-1 p-2 block w-full rounded-md border-gray-300 border shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('due_date') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required
                            class="p-2 mt-1 block w-full rounded-md border-gray-300 border shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            <option value=""></option>
                    ...
                    <div class="hidden" id="messageField">
                        ...
                        <textarea rows='4' type="text" name="message" class="mt-1 p-2 block w-full rounded-md border-gray-300 border shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('message') border-red-500 @enderror" placeholder="Tulis alasan anda"></textarea>
                        @error('message')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <button type="submit"
                            class="mt-1 inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            Update
                        </button>
                    </div>
                </form>
