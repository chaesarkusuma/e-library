            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <form action="/dashboard/book/{{ $book->slug }}" method="POST" class="text-red-500 hover:text-red-500">
                            @csrf
                            @method('delete')
                        ...
                        <div class="text-yellow-500 hovet:text-yellow-600">
                            <a href="/dashboard/book/{{ $book->slug }}/edit"><i class="fa-pen fa-solid fa-square"></i>Edit</a>
                        </div>
                    </td>
                </tr>
