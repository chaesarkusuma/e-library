<nav class="bg-gray-800" x-data="{ isOpen: false }">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="hidden md:block">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div 
                            ...
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">{{ auth()->user()->username }}</a>
                            ...
                            <form action="/logout" method="post">
                                @csrf
                                <button onclick="return confirm('Apakah anda yakin ingin logout?')" type="submit" class="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition w-full text-left" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</button>
                            </form>
                        </div>
                    </div>
                    </div>
                ...
                @else
                    <a class="bg-indigo-500 px-3 py-2 rounded text-white hover:bg-indigo-800 transition-colors duration-300" href="/login">Login</a>
                @endauth
                </div>
            </div>
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                ...
                <div class="mt-3 space-y-1 px-2">
                    ...
                    <form action="/logout" method="post">
                        @csrf
                        <button type="submit" onclick="return confirm('Apakah anda yakin ingin logout?')" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Sign out</button>
                    </form>
                </div>
                </div>
            </div>   
